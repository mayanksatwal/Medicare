...
function Dashboard() {
        ...
        <div className="premium-content">
          ...
          <section className="welcome">
            ...
            <div className="welcome-left">
              ...
              <div>
                <span className="eyebrow">YOUR HEALTH, YOUR SPACE</span>
  ...
  <div className="section-heading-row">
    <div>
      ...
      <p>Your upcoming consultation at a glance.</p>
    </div>
  ...
  <section className="my-doctors-section" id="doctors">

  <div className="section-heading-row">
    <div>
      <span className="section-kicker">YOUR CARE TEAM</span>
      <h2>My Doctors</h2>
      <p>Doctors you've recently consulted with.</p>
    </div>
  ...
  <div className="my-doctors-grid">
    ...
    <div className="my-doctor-card">
      ...
      <Link to="/appointment" className="doctor-book-btn">
        Book
      </Link>
    </div>
    ...
    <div className="my-doctor-card">
      ...
      <Link to="/appointment" className="doctor-book-btn">
        Book
          ...
          {/* RECENT APPOINTMENTS */}
          <section className="glass-section" id="doctors">
          ...
          <footer className="dashboard-footer">
            ...
            <span>Private · Secure · Designed around you</span>
          </footer>
